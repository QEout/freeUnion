      ...
      <div class="page-login--content"
            ...
            <el-card shadow="never">
              ...
              <el-form :model="ruleForm2"
                ...
                <el-form-item label=""
                  ...
                  <el-input placeholder="请输入内容">
                    <el-button slot="prepend"
                               size="default"
                               type="primary"
                               class="button-login">获取验证码</el-button>
                  </el-input>
                </el-form-item>
                <el-form-item :label="Npass"
                              prop="pass">
                ...
                <el-form-item label="昵称"
                              prop="nick"
                              v-show="show2">
                  <el-input v-model.number="ruleForm2.nick"></el-input>
                </el-form-item>
                <el-form-item>
                  <el-button @click="submitForm('ruleForm2')"
                             v-show="show3">提交注册</el-button>
                  <el-button @click="resetForm('ruleForm2')"
                             v-show="!show3">重置密码</el-button>
                </el-form-item>
              </el-form>
              <!-- 注册 -->
              <!-- 登录 -->
        ...
        <div class="page-login--content-footer">
          ...
          <p class="page-login--content-footer-copyright">
            Copyright
            <d2-icon name="copyright" /> 2018 D2 Projects 开源组织出品 <a href="https://github.com/FairyEver">@FairyEver</a>
          </p>
        </div>
      </div>
    </div>
  ...
  data() {
    ...
    var checknick = (rule, value, callback) => {
      if (!value) {
        ...
        // console.log(reg.test(value));
        if (reg.test(value)) {
          return callback(new Error('禁止输入敏感字符'))
        } else {
          callback()
        }
      }
  ...
  methods: {
    ...
    toReg() {
      if (this.toggle == '注册账号') {
        ...
        ;(this.show1 = true), (this.toggle = '注册账号')
      }
    },
    toReset() {
      ;(this.show1 = false),
